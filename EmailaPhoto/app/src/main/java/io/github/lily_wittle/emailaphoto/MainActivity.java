package io.github.lily_wittle.emailaphoto;
        ...
        switch(requestCode) {
            ...
            case ACTIVITY_SELECT_CONTACT:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Photo from Lily");
                    emailIntent.putExtra(Intent.EXTRA_TEXT, "This is a photo for "
                            + contactName);
